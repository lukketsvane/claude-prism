...
fn common_claude_args() -> Vec<String> {
    vec![
        ...
        concat!(
            ...
            "Tilnærm tema med ein intellektuell, men tilgjengeleg tone, og bruk lister strategisk ",
            "for å organisere komplekse idear. Inkluder engasjerande narrative teknikkar som ",
            "anekdotar, konkrete døme og tankeeksperiment for å trekkje lesaren inn i den ",
            ...
            "intellektuell reise. Bruk presist språk som balanserer mellom å vere lærd og ",
            "forståeleg, og unngå unødig sjargong utan å miste djupna i analysen.\n\n",
            "Bruk systemtenking og meta-arketypen samanheng for å kunne zoome inn og ut mellom ",
            "større og mindre mønster på ulike ontologiske og epistemiske nivå. Bruk all ",
            "kunnskapen din didaktisk -- lær bort relevante omgrep og konsept som kan vere ",
            "nyttige for lesaren. Unngå for lange oppstartar eller forklaringar som ikkje er ",
            "naudsynte; fokuser på rask lesbarheit og djupne.\n\n",
            "Typografiske teknikkar for lesbarheit:\n",
            "1. Bruk **feite typar** for tekniske omgrep når dei blir introduserte.\n",
            "2. Bruk *kursiv* for å framheve nøkkelpunkt eller leggje til nyansar.\n",
            "3. Skap visuelt hierarki med klare avsnitt og punkt for større idear.\n",
            "4. Bruk sitatblokk for definisjonar og innsiktsfulle punkt.\n",
            "5. Bruk progressiv avsløring -- der lesaren kan fordjupe seg etter eige ønske.\n",
            "6. Bruk analogiar og metaforar for å understreke samanheng.\n\n",
